  ...
  <aside class="w-64 bg-[#f4f3ec] dark:bg-[#1a1c1e] flex flex-col justify-between hidden md:flex shrink-0 h-screen sticky top-0 transition-colors duration-200 border-r border-transparent dark:border-gray-800">
    <div>
      ...
      <nav class="mt-4 px-4 space-y-2">
        <router-link to="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors" :class="route.path === '/dashboard' ? 'bg-white text-[#1a3b22] dark:bg-gray-800 dark:text-green-400 font-semibold shadow-sm' : 'text-gray-500 hover:text-[#1a3b22] hover:bg-white/50 dark:text-gray-400 dark:hover:text-green-400 dark:hover:bg-gray-800/50'">
          <LayoutDashboard class="w-5 h-5 shrink-0" />
          Home
          <div v-if="route.path === '/dashboard'" class="ml-auto w-1 h-6 bg-[#1a3b22] dark:bg-green-400 rounded-full"></div>
        </router-link>
        <router-link to="/map" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors" :class="route.path === '/map' ? 'bg-white text-[#1a3b22] dark:bg-gray-800 dark:text-green-400 font-semibold shadow-sm' : 'text-gray-500 hover:text-[#1a3b22] hover:bg-white/50 dark:text-gray-400 dark:hover:text-green-400 dark:hover:bg-gray-800/50'">
          <MapIcon class="w-5 h-5 shrink-0" />
          Map
          <div v-if="route.path === '/map'" class="ml-auto w-1 h-6 bg-[#1a3b22] dark:bg-green-400 rounded-full"></div>
        </router-link>
        <router-link to="/reports" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors" :class="route.path === '/reports' ? 'bg-white text-[#1a3b22] dark:bg-gray-800 dark:text-green-400 font-semibold shadow-sm' : 'text-gray-500 hover:text-[#1a3b22] hover:bg-white/50 dark:text-gray-400 dark:hover:text-green-400 dark:hover:bg-gray-800/50'">
          <Activity class="w-5 h-5 shrink-0" />
          Reports
          <div v-if="route.path === '/reports'" class="ml-auto w-1 h-6 bg-[#1a3b22] dark:bg-green-400 rounded-full"></div>
        </router-link>
        <router-link to="/profile" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors" :class="route.path === '/profile' ? 'bg-white text-[#1a3b22] dark:bg-gray-800 dark:text-green-400 font-semibold shadow-sm' : 'text-gray-500 hover:text-[#1a3b22] hover:bg-white/50 dark:text-gray-400 dark:hover:text-green-400 dark:hover:bg-gray-800/50'">
          <User class="w-5 h-5 shrink-0" />
          Profile
          <div v-if="route.path === '/profile'" class="ml-auto w-1 h-6 bg-[#1a3b22] dark:bg-green-400 rounded-full"></div>
        </router-link>
      </nav>
    </div>
